...
<body>
	...
	<div id="MainArea">
		<table cellspacing="0" cellpadding="0" class="TableStyle">
			<h3 style="text-align:center">20岁以下员工列表(${user20count}人)</h3>
			<!-- 表头-->
			<thead>
	...
	<div id="MainArea">
		<table cellspacing="0" cellpadding="0" class="TableStyle">
			<h3 style="text-align:center">21-35岁员工列表(${user35count}人)</h3>
			<!-- 表头-->
			<thead>
				<tr align=center valign=middle id=TableTitle>
					<td width="100">登录名</td>
	...
	<div id="MainArea">
		<table cellspacing="0" cellpadding="0" class="TableStyle">
			<h3 style="text-align:center">35岁以上员工列表(${userelsecount}人)</h3>
			<!-- 表头-->
			<thead>
				<tr align=center valign=middle id=TableTitle>
					<td width="100">登录名</td>
